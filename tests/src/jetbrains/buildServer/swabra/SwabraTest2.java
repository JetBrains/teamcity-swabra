...
import jetbrains.buildServer.agent.impl.directories.DirectoryCleaner;
import jetbrains.buildServer.agent.impl.directories.DirectoryCleanerCallback;
import jetbrains.buildServer.agent.impl.directories.FileRemover;
import jetbrains.buildServer.agent.impl.directories.SmartDirectoryCleanerImpl;
import jetbrains.buildServer.agentServer.Server;
import jetbrains.buildServer.artifacts.ArtifactDependencyInfo;
import jetbrains.buildServer.parameters.ValueResolver;
import jetbrains.buildServer.util.ActionThrow;
...
public class SwabraTest2 extends BaseTestCase {
  ...
  public void setUp() throws Exception {
    ...
    myPropertiesProcessor = new SwabraPropertiesProcessor(myAgentDispatcher, mySwabraLogger);
